...
def main(args):
    ...
    output_dir = Path(config.DATA_DIR) / 'climatology_1.5_real'
    ...
    if args.is_spatial:
        ...
        if args.dataset_name== 'single_level_1.5':
            ...
            PARAMS = config.ERA5_PRESSURE_LIST
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_name',default='pressure_level_1.5', help='single_level_merge,pressure_level')
